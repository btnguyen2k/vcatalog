...
<body class="[:$DOJO_THEME:]">
    ...
    <thead>
        <tr>
            <th style="text-align: left;">[:$MODEL.language->getMessage('msg.username'):]</th>
            <th style="text-align: center;">[:$MODEL.language->getMessage('msg.fullName'):]</th>
            <th style="text-align: center;">[:$MODEL.language->getMessage('msg.email'):]</th>
            <th style="text-align: center;">[:$MODEL.language->getMessage('msg.groupName'):]</th>
