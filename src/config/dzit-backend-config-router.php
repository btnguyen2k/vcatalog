...
$router = Array('*' => 'Vcatalog_Controller_Admin_HomeController', 
        ...
        'users' => 'Vcatalog_Controller_Admin_UserListController', 
        'deleteUser' => 'Vcatalog_Controller_Admin_DeleteUserController', 
        'createUser' => 'Vcatalog_Controller_Admin_CreateUserController', 
        'editUser' => 'Vcatalog_Controller_Admin_EditUserController');
