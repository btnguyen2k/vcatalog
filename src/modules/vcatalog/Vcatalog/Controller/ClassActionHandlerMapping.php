...
$YADIF_CONFIG = Array(
        ...
        'Vcatalog_Controller_Admin_UserListController' => Array(
                'class' => 'Vcatalog_Controller_Admin_UserListController', 
                'scope' => 'singleton', 
                'methods' => Array(
                        Array('method' => 'setRequireAuthentication', 'arguments' => Array(TRUE)), 
                        Array('method' => 'setAllowedUserGroups', 'arguments' => Array(1)))), 
        
        'Vcatalog_Controller_Admin_DeleteUserController' => Array(
                'class' => 'Vcatalog_Controller_Admin_DeleteUserController', 
                'scope' => 'singleton', 
                'methods' => Array(
                        Array('method' => 'setRequireAuthentication', 'arguments' => Array(TRUE)), 
                        Array('method' => 'setAllowedUserGroups', 'arguments' => Array(1)))), 
         
         'Vcatalog_Controller_Admin_EditUserController' => Array(
                'class' => 'Vcatalog_Controller_Admin_EditUserController', 
                'scope' => 'singleton', 
                'methods' => Array(
                        Array('method' => 'setRequireAuthentication', 'arguments' => Array(TRUE)), 
                        Array('method' => 'setAllowedUserGroups', 'arguments' => Array(1)))),
        
        'Vcatalog_Controller_Admin_CreateUserController' => Array(
                'class' => 'Vcatalog_Controller_Admin_CreateUserController', 
                'scope' => 'singleton', 
                'methods' => Array(
                        Array('method' => 'setRequireAuthentication', 'arguments' => Array(TRUE)), 
                        Array('method' => 'setAllowedUserGroups', 'arguments' => Array(1)))));
