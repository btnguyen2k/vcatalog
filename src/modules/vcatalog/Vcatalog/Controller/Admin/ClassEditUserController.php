<?php
class Vcatalog_Controller_Admin_EditUserController extends Vcatalog_Controller_Admin_BaseFlowController {
    ...
    protected function populateParams() {
        ...
        /**
         *
         * @var Vcatalog_Bo_User_MysqlUserDao
         */
